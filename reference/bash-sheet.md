...
`0`: **Standard Input**
- This is where processes normally read information from.

`1`: **Standard Output**
- This is where processes normally write all their output to.

`2`: **Standard Error**
- This is where processes normally write their error messages to.
...
If you're new to bash or want some details, explanation and/or examples on parameter operations, go read [[BashGuide/Parameters#Parameter_Expansion|the BashGuide's section on Parameter Expansion]] and [[BashFAQ/073]].
...
If you're new to bash or don't fully grasp what arrays are and why one would use them in favor of normal variables, or you're looking for more explanation and/or examples on arrays, go read [[BashGuide/Arrays|the BashGuide's section on Arrays]] and [[BashFAQ/005]]
